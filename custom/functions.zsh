...
function drwho() {
  ...
  # zmv -n 's(*)e(*)p([0-9]##).avi' '/Volumes/media/Entertainment/TV/Doctor Wh1 (1963)/Season $1/Doctor Who - s$1e${(l(2)(0))$(($3+$incr))}.avi'
  print "Do it? "
  read cont
  if [[ $cont = "y" ]]; then
    zmv 's(*)e(*)p([0-9]##) (*).avi' '/Volumes/media/Entertainment/TV/Doctor Wh1 (1963)/Season $1/Doctor Who - s$1e${(l(2)(0))$(($3+$incr))} - $4.avi'
    # zmv 's(*)e(*)p([0-9]##).avi' '/Volumes/media/Entertainment/TV/Doctor Wh1 (1963)/Season $1/Doctor Who - s$1e${(l(2)(0))$(($3+$incr))}.avi'
  fi
}
